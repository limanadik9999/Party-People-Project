...
def account(request, account_id):
    ...
    context = {'other_user': user, 'user_events': event_list, 'is_friend': is_friend, "friends1": users_friends1, "friends2": users_friends2, 'is_follower': is_follower, 'user_following': user_following}
